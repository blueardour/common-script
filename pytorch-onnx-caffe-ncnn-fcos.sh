...
case=FCOS_R_18_1x-Full-BN

#--config-file configs/FCOS-COCO-Detection/fcos_R_18_1x-Full_BN.yaml
#--input output/test/input.jpg --output output/test/output.jpg
#--opts MODEL.WEIGHTS output/fcos/R_18_1x-Full_BN/model_final.pth
if [ ! -e $onnx_repo/$case.onnx ] || [ "$update" != "" ];
then
  cd /workspace/git/AdelaiDet/ # folder of project https://github.com/aim-uofa/AdelaiDet
  pwd
